...
namespace Comision.Ui.Areas.Admin.Controllers
{
    public partial class AuthenticationController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AuthenticationController Actions { get { return MVC.Admin.Authentication; } }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string GetAuthentication = "GetAuthentication";
        ...
        static readonly ActionParamsClass_GetAuthentication s_params_GetAuthentication = new ActionParamsClass_GetAuthentication();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_GetAuthentication GetAuthenticationParams { get { return s_params_GetAuthentication; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_GetAuthentication
        {
        ...
        {
            public readonly string authenticationType = "authenticationType";
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Areas/Admin/Views/Authentication/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AuthenticationController : Comision.Ui.Areas.Admin.Controllers.AuthenticationController
    {
        ...
        [NonAction]
        partial void GetAuthenticationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int page, int rows);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetAuthentication(int page, int rows)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.GetAuthentication);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "page", page);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "rows", rows);
            GetAuthenticationOverride(callInfo, page, rows);
            return callInfo;
        }
        ...
        [NonAction]
        partial void FileUploadOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int authenticationType, System.Web.HttpPostedFileBase excelFile);

        [NonAction]
        public override System.Web.Mvc.ActionResult FileUpload(int authenticationType, System.Web.HttpPostedFileBase excelFile)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.FileUpload);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "authenticationType", authenticationType);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "excelFile", excelFile);
            FileUploadOverride(callInfo, authenticationType, excelFile);
            return callInfo;
        }
